...
Public Class Form4
    ...
    Dim hint_usada As Boolean = False, n_hints As Integer = 8, inform(2) As String
    ...
    Sub europa()
        ...
        ElseIf d = 45 Then
            ...
            If n_hints = 8 Then
                inform(1) = vbCrLf & "Não usaste nenhuma ajuda!"
            ElseIf n_hints = 7 Or n_hints = 5 Then
                inform(1) = vbCrLf & "Precisaste de pouca ajuda até! Só utilizaste " & 8 - n_hints & " hints."
            ElseIf n_hints < 5 And n_hints > 1 Then
                inform(1) = vbCrLf & "Precisaste de " & 8 - n_hints & " hints."
    ...
    Private Sub BatotasToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BatotasToolStripMenuItem.Click
    ...
    Private Sub NovoJogoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NovoJogoToolStripMenuItem.Click
        ...
        inform(2) = vbCrLf & vbCrLf & "Vejo que não usaste nenhuma Batota, parabéns!"

        codigo = File.ReadAllLines("C:\Recursos\Texto\Code_2_1.read")
        linhas = File.ReadAllLines("C:\Recursos\Texto\Code_2_2_escolha.read")
    ...
    Private Sub BatotaToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BatotaToolStripMenuItem.Click
        ...
        inform(2) = vbCrLf & vbCrLf & "Bem, usaste batota! Fico contente com isso. :D"
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        hint = File.ReadAllLines("C:\Recursos\Texto\Code_2_2_hints.read")
